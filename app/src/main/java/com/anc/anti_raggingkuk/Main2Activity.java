...
import com.anc.anti_raggingkuk.LocationUtil.PermissionUtils;
import com.anc.anti_raggingkuk.LocationUtil.PermissionUtils.PermissionResultCallback;
...
public class Main2Activity extends AppCompatActivity implements ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        permissionUtils=new PermissionUtils(Main2Activity.this);
    ...
    protected void sendSMS() {
        ...
        smsIntent.putExtra("sms_body"  , "I am in Emergency someone is Ragging me Please Help me\n" + tvAddress.getText().toString());
        ...
        if(locationAddress!=null)
        {
            ...
            if(!TextUtils.isEmpty(address))
            {
                ...
                if(tvAddress.getText() ==null){
                    Toast.makeText(Main2Activity.this,
                            "Service not available try again later or try rebooting your device", Toast.LENGTH_SHORT).show();
                }
